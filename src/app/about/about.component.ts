...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({
      name: 'description',
      content:
        'Cette application a été développée avec Angularversion 13.1.1 et bootstrap 5.1.3' +
        ' Elle applique le Routing, le Lazy loading, le Serverside rendering et les Progressive Web App (PWA)',
    });
  }
